...
function wp_limit_login_plugin_options() {
    ...
    <img src="'.plugin_dir_url( __FILE__ )  .'/images/warn.png""> <b>WP Limit Login attempts Lite</b>
     is a fully functional but limited version of <b><a href="http://www.ciphercoin.com/wp-limit-login-attempts-2/" target="_blank">WP Limit Login attempts Pro (Free)</a></b>. Consider upgrading to get access to all premium features and premium support.
  </div>';
 ...
 echo '<div class="warn_msg">
    <img src="'.plugin_dir_url( __FILE__ )  .'/images/warn.png"">   Please consider upgrading to <b><a href="http://www.ciphercoin.com/wp-limit-login-attempts-2/" target="_blank">WP Limit Login attempts Pro (Free)</a></b> if you want to use this feature.
  </div>'; 
}
